...
@Slf4j
@Service
@ConditionalOnBean(name = "sqlServerDataSourceRegistry")
public class SqlServerService {
    ...
    public SqlServerService(@Qualifier("sqlServerDataSourceRegistry") JdbcDataSourceRegistry registry) {
    ...
    public List<Map<String, Object>> executeQuery(String dataSourceName, String sql) throws SQLException {
        ...
        log.info("Executing query on datasource '{}': {}", actualDsName, sql);
    ...
    public int executeUpdate(String dataSourceName, String sql) throws SQLException {
        DataSource dataSource = registry.getDataSource(dataSourceName);
        String actualDsName = dataSourceName != null ? dataSourceName : registry.getDefaultDataSourceName();
        log.info("Executing update on datasource '{}': {}", actualDsName, sql);
    ...
    public List<String> listTables(String dataSourceName) throws SQLException {
        DataSource dataSource = registry.getDataSource(dataSourceName);
        String actualDsName = dataSourceName != null ? dataSourceName : registry.getDefaultDataSourceName();
        log.info("Listing tables on datasource '{}'", actualDsName);
    ...
    public List<Map<String, Object>> executeStoredProcedure(String procedureName, Map<String, Object> params) throws SQLException {
        return executeStoredProcedure(null, procedureName, params);
    }

    /**
     * 执行存储过程（指定数据源）
     */
    public List<Map<String, Object>> executeStoredProcedure(String dataSourceName, String procedureName, Map<String, Object> params) throws SQLException {
        DataSource dataSource = registry.getDataSource(dataSourceName);
        String actualDsName = dataSourceName != null ? dataSourceName : registry.getDefaultDataSourceName();
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            CallableStatement stmt = conn.prepareCall(sqlBuilder.toString());
