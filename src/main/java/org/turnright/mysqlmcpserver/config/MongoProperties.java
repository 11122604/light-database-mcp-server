...
public class MongoProperties {
    ...
    /**
     * 是否启用 MongoDB（默认 false，需要显式设置 true）
     */
     ...
     * 多数据源配置列表
     */
    private List<MongoDataSourceConfig> datasources = new ArrayList<>();

    /**
     * 获取所有数据源配置（仅多源）
     */
    public List<MongoDataSourceConfig> getAllDatasourceConfigs() {
        return datasources;
    }
